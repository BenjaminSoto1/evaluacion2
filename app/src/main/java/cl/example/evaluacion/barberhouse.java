...
public class barberhouse extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barberhouse);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                View infoWindow = getLayoutInflater().inflate(R.layout.custominfobarrberhouse, null);
                ...
                if (tag != null && tag instanceof barberhouse.CustomInfo) {
                    barberhouse.CustomInfo customInfo = (barberhouse.CustomInfo) tag;
